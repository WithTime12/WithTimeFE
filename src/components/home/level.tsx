...
function Level() {
    return (
        <MainCard>
            <div className="flex items-center py-[48px] sm:px-[30px] lg:gap-[26px] gap-[30px] min-w-full w-full flex-col md:flex-row">
                <img
                    src={ramji}
                    alt="캐릭터"
                    className="w-[240px] h-[240px] lg:w-[200px] lg:h-[200px] aspect-square rounded-[12px] bg-[#F6E6FF] object-cover"
                />
                <div className="flex flex-col w-fit px-[30px]">
